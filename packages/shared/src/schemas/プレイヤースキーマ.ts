...
// 型推論のためのtype alias
export type プレイヤー作成リクエスト = z.infer<typeof プレイヤー作成スキーマ>;
export type プレイヤーレスポンス = z.infer<typeof プレイヤースキーマ>;
export type プレイヤー作成レスポンス = z.infer<typeof プレイヤー作成レスポンススキーマ>;